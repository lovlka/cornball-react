      ...
      return (
         <Modal title="Om Lantisen" dismiss="Stäng">
            <div>
               ...
               <p>Bli fan av Lantisen på Facebook! Där har du möjlighet att framföra synpunkter eller komma i kontakt med mig. Tack för att du spelar Lantisen!</p><br />
               <p><img src="victor.png" alt="Victor Stodell" /></p>
            </div>
         </Modal>
      );
   }
